...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  map.scrollWheelZoom.disable(); //to disa
};
...
var resetPasswordForm = document.querySelector('.form-password-reset');
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 5;
            return (0, _login.forgotPassword)(email);
          case 5:
          case "end":
